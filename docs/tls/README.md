# How to secure access to Buckit server with TLS [![Slack](https://slack.min.io/slack?type=svg)](https://slack.min.io)

This guide explains how to configure Buckit Server with TLS certificates on Linux and Windows platforms.

1. [Install Buckit Server](#install-minio-server)
2. [Use an Existing Key and Certificate with Buckit](#use-an-existing-key-and-certificate-with-buckit)
3. [Generate and use Self-signed Keys and Certificates with Buckit](#generate-use-self-signed-keys-certificates)
4. [Install Certificates from Third-party CAs](#install-certificates-from-third-party-cas)

## 1. Install Buckit Server

Install Buckit Server using the instructions in the [Buckit Quickstart Guide](https://buckit-io.github.io/docs/community/minio-object-store/operations/deployments/baremetal-deploy-minio-on-redhat-linux.html).

## 2. Use an Existing Key and Certificate with Buckit

This section describes how to use a private key and public certificate that have been obtained from a certificate authority (CA). If these files have not been obtained, skip to [3. Generate Self-signed Certificates](#generate-use-self-signed-keys-certificates) or generate them with [Let's Encrypt](https://letsencrypt.org) using these instructions: [Generate Let's Encrypt certificate using Certbot for Buckit](https://buckit-io.github.io/docs/community/minio-object-store/integrations/generate-lets-encrypt-certificate-using-certbot-for-buckit.html). For more about TLS and certificates in Buckit, see the [Network Encryption documentation](https://buckit-io.github.io/docs/community/minio-object-store/operations/network-encryption.html).
...
## 3. Generate and use Self-signed Keys and Certificates with Buckit
...
* Buckit only supports keys and certificates in PEM format on Linux and Windows.
* Buckit doesn't currently support PFX certificates.
...
The default OpenSSL format for private encrypted keys is PKCS-8, but Buckit only supports PKCS-1. An RSA key that has been formatted with PKCS-8 can be converted to PKCS-1 using the following command:
...
* [TLS Configuration for Buckit server on Kubernetes](https://buckit-io.github.io/docs/tls/kubernetes)
* [Buckit Client Complete Guide](https://buckit-io.github.io/docs/community/minio-object-store/reference/minio-mc.html)
* [Buckit Network Encryption Overview](https://buckit-io.github.io/docs/community/minio-object-store/operations/network-encryption.html)
* [Generate Let's Encrypt Certificate](https://buckit-io.github.io/docs/community/minio-object-store/integrations/generate-lets-encrypt-certificate-using-certbot-for-buckit.html)
* [Setup nginx Proxy with Buckit Server](https://buckit-io.github.io/docs/community/minio-object-store/integrations/setup-nginx-proxy-with-buckit.html)
