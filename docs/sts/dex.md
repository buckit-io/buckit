...
### Configure Buckit server with Dex
...
On the browser now you shall see the list of buckets output, along with your temporary credentials obtained from Buckit.
...
Now you have successfully configured Dex IdP with Buckit.
...
and add relevant policies on Buckit using `mc admin policy create myminio/ <group_name> group-access.json`
