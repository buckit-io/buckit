# Buckit Server Debugging Guide [![Slack](https://slack.min.io/slack?type=svg)](https://slack.min.io) [![Docker Pulls](https://img.shields.io/docker/pulls/minio/minio.svg?maxAge=604800)](https://hub.docker.com/r/minio/minio/)

## HTTP Trace

HTTP tracing can be enabled by using [`mc admin trace`](https://buckit-io.github.io/docs/community/minio-object-store/reference/minio-mc-admin/mc-admin-trace.html) command.
...
```bash
go install github.com/buckit-io/buckit/docs/debugging/xl-meta@latest
```
...
```bash
go install github.com/buckit-io/buckit/docs/debugging/inspect@latest
```
