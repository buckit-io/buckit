...
// and GOROOT directories. Also append github.com/buckit-io/buckit
...
func Init(goPath string, goRoot string) {
	...
	// Add "github.com/buckit-io/buckit" as the last to cover
	// paths like "{GOROOT}/src/github.com/buckit-io/buckit"
	// and "{GOPATH}/src/github.com/buckit-io/buckit"
