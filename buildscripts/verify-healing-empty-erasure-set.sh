...
function start_minio_3_node() {
	...
	args=""
	for i in $(seq 1 3); do
		args="$args http://${MINIO_HOST}:$((start_port + i))${WORK_DIR}/$i/1/ http://${MINIO_HOST}:$((start_port + i))${WORK_DIR}/$i/2/ http://${MINIO_HOST}:$((start_port + i))${WORK_DIR}/$i/3/ http://${MINIO_HOST}:$((start_port + i))${WORK_DIR}/$i/4/ http://${MINIO_HOST}:$((start_port + i))${WORK_DIR}/$i/5/ http://${MINIO_HOST}:$((start_port + i))${WORK_DIR}/$i/6/"
	done
