...
const (
	...
	ErrBackendDown
	// Add new extended error codes here.
	// Please open a https://github.com/buckit-io/buckit/issues before adding
...
var errorCodes = errorCodeMap{
	...
	ErrUnsupportedNotification: {
		...
		Description:    "Buckit server does not support Topic or Cloud Function based notifications.",
		HTTPStatusCode: http.StatusBadRequest,
	},
	ErrInvalidCopyPartRange: {
		Code:           "InvalidArgument",
